...
int adventurer_card(int currentPlayer, struct gameState *state)
{
    ...
    //BUG instead of two drawn treasures, you draw one.
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
    case adventurer:
        return adventurer_card(currentPlayer, state);
    ...
    case mine:
        return mine_card(currentPlayer, state, handPos, choice1, choice2);
